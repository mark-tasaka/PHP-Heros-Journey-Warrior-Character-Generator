...
<html>
<head>
<title>Launch Page: The Hero's Journey 2e Warrior Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="The Hero's Journey 2e Warrior Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/hero/more/classes/warrior/"  class="text_link" target="_blank"><span class="bold">Humble Beginnings and Bold Adventures: A Hero's Journey Fan Site</span></a></p>
        ...
        <br/>
            ...
            <span class="formIputDescription">Armour:</span>	
			  <select id="armourV3" name="theArmour" class="alignmentBox">			
				...
				<option value="3" selected>Hauberk</option>
				<option value="4">Corslet</option>
    ...
    <span class="formIputDescription">Shield:</span>	
			  <select id="shieldV3" name="theShield" class="alignmentBox">			
				...
				<option value="3">Large Shield</option>
			  </select>
    ...
    <br/>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#WarriorFormV3").attr('action', "character/hjWarrior.php");
